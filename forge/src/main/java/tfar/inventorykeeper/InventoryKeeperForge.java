...
import tfar.inventorykeeper.network.PacketHandler;
...
public class InventoryKeeperForge {
    ...
    public InventoryKeeperForge() {
        ...
        if (FMLEnvironment.dist.isClient()) {
            InventoryKeeperForgeClient.init(bus);
        }
    ...
    void command(RegisterCommandsEvent event) {
        InventoryKeeper.commands(event.getDispatcher());
    }
